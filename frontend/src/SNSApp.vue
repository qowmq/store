        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="searchOrderHistories"
                        to="/orders/searchOrderHistories"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: 'SearchOrderHistory', 
                description: 'search order history을 관리하는 화면입니다.', 
                key: 'searchOrderHistories', 
                route: '/orders/searchOrderHistories',
                ImageUrl: '',
            },
